package space.springbok.health.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, space.springbok.health.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, space.springbok.health.repository.UserRepository.USERS_BY_EMAIL_CACHE);
