...
/**
 * REST controller for managing {@link space.springbok.health.domain.Weight}.
 */
@RestController
@RequestMapping("/api")
public class WeightResource {
    ...
    public ResponseEntity<List<Weight>> searchWeights(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
